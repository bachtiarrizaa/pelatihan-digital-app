        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <div>
                <div className="flex items-center gap-x-3">
                    ...
                    <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full">240 users</span>
                </div>

                <p className="mt-1 text-sm text-gray-500">These companies have purchased in the last 12 months.</p>
            </div>

            <div className="flex flex-col md:flex-row items-center sm:mt-4 gap-3">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                        <div className="flex items-center gap-x-2">
                                            <p className="px-3 py-1 text-xs text-indigo-500 rounded-fullbg-indigo-100/60">Design</p>
                                ...
                                <tr>
                                        ...
                                        <div className="inline-flex items-center gap-x-3">
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm font-normal text-gray-600">@ameliaanderson</p>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">Lead Developer</td>
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">ameliaanderson@example.com</td>
                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                        <div className="flex items-center gap-x-2">
                                ...
                                <tr>
                                        ...
                                        <div className="inline-flex items-center gap-x-3">
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm font-normal text-gray-600">@junior</p>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">Products Managers</td>
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">junior@example.com</td>
                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                        <div className="flex items-center gap-x-2">
                                            <p className="px-3 py-1 text-xs text-indigo-500 rounded-full bg-indigo-100/60">Design</p>
                                            <p className="px-3 py-1 text-xs text-blue-500 rounded-full bg-blue-100/60">Product</p>
                                ...
                                <tr>
                                        ...
                                        <div className="inline-flex items-center gap-x-3">
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm font-normal text-gray-600">@oliviawathan</p>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">Lead Designer</td>
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">oliviawathan@example.com</td>
                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                        <div className="flex items-center gap-x-2">
                                            <p className="px-3 py-1 text-xs text-indigo-500 rounded-full bg-indigo-100/60">Design</p>
                                            <p className="px-3 py-1 text-xs text-blue-500 rounded-full bg-blue-100/60">Product</p>
                                ...
                                <tr>
                                        ...
                                        <div className="inline-flex items-center gap-x-3">
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm font-normal text-gray-600">@mia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">Graphic Designer</td>
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">mia@example.com</td>
                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                        <div className="flex items-center gap-x-2">
                                            <p className="px-3 py-1 text-xs text-indigo-500 rounded-full bg-indigo-100/60">Design</p>
                                            <p className="px-3 py-1 text-xs text-blue-500 rounded-full bg-blue-100/60">Product</p>
